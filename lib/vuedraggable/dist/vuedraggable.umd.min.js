(function (t, e) {
  ...
  return (function (t) {
    ...
    '4df4': function (t, e, r) {
      ...
      t.exports = function (t) {
        ...
        if (
          ...
          for (e = a(v.length), r = new h(e); e > x; x++)
            (p = y ? g(v[x], x) : v[x]), u(r, x, p);
        else
          for (
            l = m.call(v), d = l.next, r = new h();
            !(s = d.call(l)).done;
            x++
          )
      ...
      var n = r('83ab'),
        ...
        a = function (t) {
          return function (e) {
            ...
            while (f > s)
              (r = u[s++]),
                (n && !c.call(a, r)) || l.push(t ? [r, a[r]] : a[r]);
            return l;
          };
        };
      ...
      (a[h] = !0),
        (t.exports =
          ...
          function (t, e) {
            ...
            return (
              null !== t
                ? ((b[p] = o(t)), (r = new b()), (b[p] = null), (r[h] = t))
                : (r = x()),
              void 0 === e ? r : i(r, e)
            );
          });
    ...
    'a4d3': function (t, e, r) {
      ...
      var n = r('23e7'),
        ...
        ct = function (t, e) {
          var r = (Q[t] = m(W[V]));
          return (
            B(r, { type: U, tag: t, description: e }),
            a || (r.description = e),
            r
          );
        },
        ...
        dt = function (t, e) {
          ...
          if (r !== q || !l(Q, n) || l(Z, n)) {
            var o = z(r, n);
            return (
              !o || !l(Q, n) || (l(r, N) && r[N][n]) || (o.enumerable = !0), o
            );
          }
        },
        pt = function (t) {
    ...
    'fb15': function (t, e, r) {
      ...
      var K = function (t) {
          var e =
            t.el || (Array.isArray(t.children) && t.children[0].el.parentNode);
          return (
            e ||
              console.error(
        ...
        { target: 'Array', proto: !0, forced: !p || !v },
        {
          slice: function (t, e) {
            ...
            if (
              ...
              return b.call(l, p, v);
            for (
              n = new (void 0 === r ? Array : r)(g(v - p, 0)), s = 0;
              p < v;
              p++, s++
            )
              p in l && f(n, s, l[p]);
