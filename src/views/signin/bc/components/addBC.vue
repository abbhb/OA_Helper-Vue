  ...
  <a-card class="add-bc">
    ...
    <div class="box-card">
      <div>
        ...
        >
          <div style="display: flex">
            ...
            <div v-for="item in bcForm.rules" :key="item.count" class="time-card">
              <div>
                第{{ item.count }}班
              </div>
              <a-form-item
              ...
              <a-form-item
                :rules="[{ required: true, message: '上班后允不允许迟到，不允许填0' }]"
                :validate-trigger="['change', 'blur']"
              ...
              <a-form-item
                :rules="[{ required: true, message: '下班前多少分钟允许打卡[记录早退但不记录旷班]' }]"
                :validate-trigger="['change', 'blur']"
              ...
              <a-form-item
                :rules="[{ required: true, message: '必须给个范围，从下班开始截止到什么时候截止下班' }]"
                :validate-trigger="['change', 'blur']"
      ...
      <div class="button_group">
        <a-button @click="addBC">添加</a-button>
      </div>
    </div>
    <div></div>
  </a-card>
