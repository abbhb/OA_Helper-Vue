      ...
      <div class="item">
        <a sa_evt="click_GiteeCommunity_login_thirdparty">
          <div class="other-login-icon">
            <div class="qq iconfont icon-hover" sa_click_bottom="qq" title="使用QQ登录" @click="otherLogin('qq')">
              <svg class="icon-logo_item" height="200" p-id="1456" t="1701871411222"
                ...
                <path
                  ...
                  fill="#FFFFFF" p-id="1458"></path>
              </svg>
            </div>
            <div class="wx iconfont icon-hover" sa_click_bottom="wx" title="使用微信登录" @click="otherLogin('wx')">
              <svg class="icon-logo_item" height="200" p-id="3376" t="1701944323479"
                   version="1.1" viewBox="0 0 1024 1024" width="200" xmlns="http://www.w3.org/2000/svg">
                <path
