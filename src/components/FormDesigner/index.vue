...
<script>
import WidgetPanel from '@/components/FormDesigner/widget-panel/index.vue';
import {createDesigner} from '@/components/FormDesigner/designer';
import {
...
} from '@/components/FormDesigner/utils/config';
